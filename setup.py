...
opts = dict(name='sparse_kmedoids',
            maintainer='Andrew Fiore-Gartland',
            maintainer_email='agartlan@fredhutch.org',
            description='Implementation of k-medoids clustering (PAM) accepts scipy.sparse distance matrix, using numba for efficiency',
            long_description=long_description,
            long_description_content_type='text/markdown',
            url='https://github.com/agartland/sparse_kmedoids',
            license='MIT',
